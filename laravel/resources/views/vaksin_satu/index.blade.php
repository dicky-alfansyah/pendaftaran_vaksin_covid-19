...
@section('title', 'Pendaftaran Vaksin Dosis Pertama')

@section('container')
<div class="container">
    <div class="card border-success mb-3">
        <h4 class="card-header bg-success text-white text-center">Pendaftaran Vaksin Dosis Pertama</h4>
        <div class="card-body">
            <form method="post" action="{{ url('/pendaftaran-vaksin/dosiske=1')}}">
                @csrf
                <div class="mb-3">
