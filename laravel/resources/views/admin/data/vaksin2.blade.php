            ...
            <div class="card card-success card-outline">
              <div class="card-header">
                <div class="content-header text-center">
                  <span class="text- center fs-6"><b>FORM PENDAFTARAN VAKSIN DOSIS KEDUA</b></span>
                </div>
              </div>
              <div class="card-body">
              <div class="mb-3">
                  @foreach ($control_form2 as $c2)
                  <a href="/pendaftaran-vaksin/dosiske-2-active={{$c2->id='2'}}" type="button" class="btn btn-success btn-sm">
                    ON
                  </a>
                  <a href="/pendaftaran-vaksin/dosiske-2-disabled={{$c2->id='2'}}" type="button" class="btn btn-danger btn-sm">
                    OFF
                  </a>
                  <button type="button" class="btn alert-primary btn-sm" disabled>
                    Status Pendaftaran : {{$c2->status}}
                  </button>
                  @endforeach
                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center" style="width: 90px">
                        <a href="/dashboard/update-status-konfirmasi-vaksin2-id={{$jv->id}}" class="btn btn-sm btn-success">
