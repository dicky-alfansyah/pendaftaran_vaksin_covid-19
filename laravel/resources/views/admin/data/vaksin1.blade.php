            ...
            <div class="card card-success card-outline">
              <div class="card-header">
                <div class="content-header text-center">
                  <span class="text- center fs-6"><b>FORM PENDAFTARAN VAKSIN DOSIS PERTAMA</b></span>
                </div>
              </div>
              <div class="card-body">
                <div class="mb-3">
                  @foreach ($control_form as $c1)
                  <a href="/pendaftaran-vaksin/dosiske-1-active={{$c1->id='1'}}" type="button" class="btn btn-success btn-sm">
                    ON
                  </a>
                  <a href="/pendaftaran-vaksin/dosiske-1-disabled={{$c1->id='1'}}" type="button" class="btn btn-danger btn-sm">
                    OFF
                  </a>
                  <button type="button" class="btn alert-primary btn-sm" disabled>
                    Status Pendaftaran : {{$c1->status}}
                  </button>
                  @endforeach
                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center" style="width: 90px">
                        <a href="/dashboard/update-status-konfirmasi-vaksin1-id={{$jv->id}}" class="btn btn-sm btn-success">
