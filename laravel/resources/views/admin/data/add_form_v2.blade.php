                    ...
                    <div class="col-md-12">
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                <div class="content-header">
                                    <span class="text- center fs-6"><b>TAMBAH DATA JENIS VAKSIN KEDUA</b></span>
                                </div>
                            </div>

                            <form method="post" action="{{ url('/dashboard/form-control-vaksin=2')}}">
                                @csrf
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="gap-2 d-md-flex justify-content-md-end">
                                        <a href="{{ url('/dashboard/form-control-vaksin=2')}}" class="btn btn-danger">Cancel</a>
