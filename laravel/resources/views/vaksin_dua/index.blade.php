...
@section('title', 'Pendaftaran Vaksin Dosis Kedua')


@section('container')
<div class="container">
    <div class="card border-success mb-3">
        <h4 class="card-header bg-success text-white text-center">Pendaftaran Vaksin Dosis Kedua</h4>
        <div class="card-body">
            <form method="post" action="{{ url('/pendaftaran-vaksin/dosiske=2')}}">
                @csrf
                <div class="mb-3">
